...
{
    internal sealed class FileEntryActionFileProperties : FileEntryAction
    {
        public FileEntryActionFileProperties(FileEntryActionsViewModel actionsViewModel) : base(actionsViewModel)
        {
        }
